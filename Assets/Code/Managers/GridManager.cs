...
{
    public class GridManager : SingletonBehaviour<GridManager>, IGridManager, IInitializable
    {
        ...
        public void Initialize()
        {
            ...
            _isServer = _gameManagerAim.IsServer();
        }
        ...
        public IEnumerator MergeCoroutine(List<Block> selectedBlocks)
        {
            ...
            {
                InputManager.instance.UpdateLineRenderer(selectedBlocks
                    .TakeLast(selectedBlocks.Count - blockToMergeIndex)
                    .ToList());
                ...
                seq.Insert(0, defenderBlock.transform
                    .DOScale(1.2f, GameplayConfiguration.instance.BlocksMergeSpeed / 2f)
                    .SetEase(Ease.InSine));
